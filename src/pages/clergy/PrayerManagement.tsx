...
const PrayerManagement = () => {
  ...
  const resetForm = () => {
    setFormData({ title: "", category: "", content: "", date: "", status: "draft" });
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Create and manage prayers for your congregation</p>
        </div>
          ...
          <CardHeader>
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div>
                ...
                <CardDescription>Manage your prayer content</CardDescription>
              </div>
